...
HD_PWD='C:/Labs/ENES246-master/-2VoltageControlledBuffer/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vcb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vcb.tcl
