...
HD_PWD='C:/Labs/ENES246-master/-2VoltageControlledBuffer/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vcb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vcb.tcl -notrace
